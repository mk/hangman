...
Elm.Maybe.make = function (_elm) {
       ...
       var andThen = F2(function (maybeValue,callback) { var _p4 = maybeValue;if (_p4.ctor === "Just") { return callback(_p4._0);} else { return Nothing;}});
       ...
       var map5 = F6(function (func,ma,mb,mc,md,me) {
                     ...
                     if (_p9.ctor === "_Tuple5" && _p9._0.ctor === "Just" && _p9._1.ctor === "Just" && _p9._2.ctor === "Just" && _p9._3.ctor === "Just" &&
                         _p9._4.ctor === "Just") {
...
Elm.List.make = function (_elm) {
       ...
       var partition = F2(function (pred,list) {
                          var step = F2(function (x,_p12) {
                                        ...
                                        var _p15 = _p13._0;
                                        var _p14 = _p13._1;
                                        return pred(x) ? {ctor: "_Tuple2",_0: A2(_op["::"],x,_p15),_1: _p14} : {ctor: "_Tuple2"
                                                                                                               ,_0: _p15
                                                                                                               ,_1: A2(_op["::"],x,_p14)};
                                     });
...
Elm.Color.make = function (_elm) {
       ...
       var hslToRgb = F3(function (hue,saturation,lightness) {
                         ...
                         var _p0 = _U.cmp(hue$,0) < 0 ? {ctor: "_Tuple3",_0: 0,_1: 0,_2: 0} : _U.cmp(hue$,1) < 0 ? {ctor: "_Tuple3",_0: chroma,_1: x,_2: 0}
                                   : _U.cmp(hue$,2) < 0 ? {ctor: "_Tuple3",_0: x,_1: chroma,_2: 0} : _U.cmp(hue$,3) < 0 ? {ctor: "_Tuple3"
                                                                                                                          ,_0: 0
                                                                                                                          ,_1: chroma
                                                                                                                          ,_2: x} : _U.cmp(hue$,4) < 0
                                   ? {ctor: "_Tuple3",_0: 0,_1: x,_2: chroma} : _U.cmp(hue$,5) < 0 ? {ctor: "_Tuple3",_0: x,_1: 0,_2: chroma} : _U.cmp(hue$,6) <
                                   0 ? {ctor: "_Tuple3",_0: chroma,_1: 0,_2: x} : {ctor: "_Tuple3",_0: 0,_1: 0,_2: 0};
                         var r = _p0._0;
                         var g = _p0._1;
                         var b = _p0._2;
...
Elm.Graphics.Element.make = function (_elm) {
       ...
       var width = F2(function (newWidth,_p10) {
                      ...
                      var newHeight = function () {
                                         ...
                                         switch (_p12.ctor)
                                         {
                                           ...
                                           case "RawHtml":
                                             return $Basics.snd(A2($Native$Graphics$Element.htmlHeight,newWidth,_p13));
                                           default:
                                             return _p14.height;
                                         }
                                      }();
       ...
       var tag = F2(function (name,_p21) {
                    var _p22 = _p21;
                    return Element_elm_builtin({element: _p22._0.element,props: _U.update(_p22._0.props,{tag: name})});
                 });
                                 ...
                                 return A2(andThen
                                          ...
                                          ,function (b) {
                                             return A2(andThen
                                                      ,taskC
                                                      ,function (c) {
                                                         return A2(andThen,taskD,function (d) { return succeed(A4(func,a,b,c,d));});
                                                      });
                                          });
                              });
                  });
                                             ...
                                             return A2(andThen
                                                      ...
                                                      ,function (c) {
                                                         return A2(andThen
                                                                  ,taskD
                                                                  ,function (d) {
                                                                     return A2(andThen,taskE,function (e) { return succeed(A5(func,a,b,c,d,e));});
                                                                  });
                                                      });
                                          });
                              });
...
Elm.Signal.make = function (_elm) {
       ...
       var _op = {};
       var send = F2(function (_p0,value) { var _p1 = _p0;return A2($Task.onError,_p1._0(value),function (_p2) { return $Task.succeed({ctor: "_Tuple0"});});});
...
Elm.Dict.make = function (_elm) {
                                        ...
                                        switch (_p18._3._0.ctor)
                                        {
                                              ...
                                              case "NBlack":
                                                if (_p18._3._3.ctor === "RBNode_elm_builtin" && _p18._3._3._0.ctor === "Red") {
                                                   ...
                                                   if (_p18._3._4.ctor === "RBNode_elm_builtin" && _p18._3._4._0.ctor === "Red") {
                                                      ...
                                                      if (_p18._0.ctor === "BBlack" && _p18._4._3.ctor === "RBNode_elm_builtin" && _p18._4._3._0.ctor ===
                                                          "Black" && _p18._4._4.ctor === "RBNode_elm_builtin" && _p18._4._4._0.ctor === "Black") {
                                                         break _v31_4;
                                                      } else {
                                                         break _v31_6;
                                                      }
                                            ...
                                            switch (_p18._4._0.ctor)
                                            {
                                              case "Red":
                                                if (_p18._4._3.ctor === "RBNode_elm_builtin" && _p18._4._3._0.ctor === "Red") {
                                                   ...
                                                   if (_p18._4._4.ctor === "RBNode_elm_builtin" && _p18._4._4._0.ctor === "Red") {
                                                      ...
                                                      if (_p18._0.ctor === "BBlack" && _p18._3._3.ctor === "RBNode_elm_builtin" && _p18._3._3._0.ctor ===
                                                          "Black" && _p18._3._4.ctor === "RBNode_elm_builtin" && _p18._3._4._0.ctor === "Black") {
                                                         break _v31_5;
                                                      } else {
                                                         break _v31_6;
                                                      }
                                              ...
                                              case "NBlack":
                                                if (_p18._0.ctor === "BBlack") {
                                                   if (_p18._4._3.ctor === "RBNode_elm_builtin" && _p18._4._3._0.ctor === "Black" && _p18._4._4.ctor ===
                                                       "RBNode_elm_builtin" && _p18._4._4._0.ctor === "Black") {
                                                      break _v31_4;
                                                   } else {
                                                      if (_p18._3._3.ctor === "RBNode_elm_builtin" && _p18._3._3._0.ctor === "Black" && _p18._3._4.ctor ===
                                              ...
                                              default:
                                                if (_p18._0.ctor === "BBlack" && _p18._3._3.ctor === "RBNode_elm_builtin" && _p18._3._3._0.ctor === "Black" &&
                                                    _p18._3._4.ctor === "RBNode_elm_builtin" && _p18._3._4._0.ctor === "Black") {
                                                   break _v31_5;
                                                } else {
                                                   break _v31_6;
                                                }
                                          ...
                                          default:
                                            switch (_p18._4._0.ctor)
                                            {
                                              ...
                                              case "NBlack":
                                                if (_p18._0.ctor === "BBlack" && _p18._4._3.ctor === "RBNode_elm_builtin" && _p18._4._3._0.ctor === "Black" &&
                                                    _p18._4._4.ctor === "RBNode_elm_builtin" && _p18._4._4._0.ctor === "Black") {
                                                   break _v31_4;
                                                } else {
                                                   break _v31_6;
                                                }
                          ...
                          if (_p32.ctor === "RBEmpty_elm_builtin") {
                             ...
                             switch (_p34.ctor)
                             {
                               ...
                               case "LT":
                                 ...
                                 {
                                   case "Same":
                                     return {ctor: "_Tuple2",_0: Same,_1: A5(RBNode_elm_builtin,_p40,_p41,_p44,newLeft,_p43)};
                                   case "Insert":
                                     return {ctor: "_Tuple2",_0: Insert,_1: A5(balance,_p40,_p41,_p44,newLeft,_p43)};
                                   default:
                                     return {ctor: "_Tuple2",_0: Remove,_1: A5(bubble,_p40,_p41,_p44,newLeft,_p43)};
                                 }
                               default:
                                 var _p38 = up(_p43);
                                 var flag = _p38._0;
                                 ...
                                 {
                                   case "Same":
                                     return {ctor: "_Tuple2",_0: Same,_1: A5(RBNode_elm_builtin,_p40,_p41,_p44,_p42,newRight)};
                                   case "Insert":
                                     return {ctor: "_Tuple2",_0: Insert,_1: A5(balance,_p40,_p41,_p44,_p42,newRight)};
                                   default:
                                     return {ctor: "_Tuple2",_0: Remove,_1: A5(bubble,_p40,_p41,_p44,_p42,newRight)};
                                 }
                             }
                          }
                       };
       ...
       var partition = F2(function (predicate,dict) {
                          var add = F3(function (key,value,_p50) {
                                       ...
                                       var _p53 = _p51._1;
                                       var _p52 = _p51._0;
                                       return A2(predicate,key,value) ? {ctor: "_Tuple2",_0: A3(insert,key,value,_p52),_1: _p53} : {ctor: "_Tuple2"
                                                                                                                                   ,_0: _p52
                                                                                                                                   ,_1: A3(insert
                                                                                                                                          ,key
                                                                                                                                          ,value
...
Elm.NativeUi.Style = Elm.NativeUi.Style || {};
Elm.NativeUi.Style.make = function (_elm) {
       "use strict";
       _elm.NativeUi = _elm.NativeUi || {};
       _elm.NativeUi.Style = _elm.NativeUi.Style || {};
       if (_elm.NativeUi.Style.values)    return _elm.NativeUi.Style.values;
       var _U = Elm.Native.Utils.make(_elm),
       $Basics = Elm.Basics.make(_elm),
       $Debug = Elm.Debug.make(_elm),
       $Json$Encode = Elm.Json.Encode.make(_elm),
       ...
       var encodeValue = function (value) {
          ...
          switch (_p0.ctor)
          {
            ...
            case "ObjectValue":
              return $Json$Encode.object(A2($List.map,encodeDeclaration,_p0._0));
            default:
              return $Json$Encode.list(A2($List.map,encodeObject,A2($List.filterMap,$Basics.identity,_p0._0)));
          }
       };
       ...
       var toJsonProperty = function (style) {
          ...
          {
            case "StringStyle":
              return {ctor: "_Tuple2",_0: _p5._0._0,_1: encodeValue(_p5._0._1)};
            case "NumberStyle":
              return {ctor: "_Tuple2",_0: _p5._0._0,_1: encodeValue(_p5._0._1)};
            case "ObjectStyle":
              return {ctor: "_Tuple2",_0: _p5._0._0,_1: encodeValue(_p5._0._1)};
       ...
       return _elm.NativeUi.Style.values = {_op: _op
...
Elm.NativeUi = Elm.NativeUi || {};
Elm.NativeUi.make = function (_elm) {
       "use strict";
       _elm.NativeUi = _elm.NativeUi || {};
       if (_elm.NativeUi.values)    return _elm.NativeUi.values;
       var _U = Elm.Native.Utils.make(_elm),
       $Basics = Elm.Basics.make(_elm),
       $Debug = Elm.Debug.make(_elm),
       ...
       $List = Elm.List.make(_elm),
       $Maybe = Elm.Maybe.make(_elm),
       $Native$NativeUi = Elm.Native.NativeUi.make(_elm),
       $NativeUi$Style = Elm.NativeUi.Style.make(_elm),
       $Result = Elm.Result.make(_elm),
       $Signal = Elm.Signal.make(_elm);
       var _op = {};
       var nativeEventHandler = $Native$NativeUi.nativeEventHandler;
       ...
       var property = F2(function (name,value) { return A2(JsonProperty,name,value);});
       ...
       var style = function (styles) { return A2(property,"style",$NativeUi$Style.encode(styles));};
       ...
       return _elm.NativeUi.values = {_op: _op
                                     ,node: node
                                     ,string: string
                                     ,view: view
                                     ,text: text
...
Elm.Main.make = function (_elm) {
       ...
       $Maybe = Elm.Maybe.make(_elm),
       $NativeUi = Elm.NativeUi.make(_elm),
       $NativeUi$NativeApp = Elm.NativeUi.NativeApp.make(_elm),
       $NativeUi$Style = Elm.NativeUi.Style.make(_elm),
       $Result = Elm.Result.make(_elm),
       $Signal = Elm.Signal.make(_elm);
       var _op = {};
       var button = F4(function (address,action,color,content) {
                       return A2($NativeUi.text
                                ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.color("white")
                                                                  ,$NativeUi$Style.textAlign("center")
                                                                  ,$NativeUi$Style.backgroundColor(color)
                                                                  ,$NativeUi$Style.paddingTop(5)
                                                                  ,$NativeUi$Style.paddingBottom(5)
                                                                  ,$NativeUi$Style.width(30)
                                                                  ,$NativeUi$Style.fontWeight("bold")
                                                                  ,$NativeUi$Style.shadowColor("#000")
                                                                  ,$NativeUi$Style.shadowOpacity(0.25)
                                                                  ,A2($NativeUi$Style.shadowOffset,1,1)
                                                                  ,$NativeUi$Style.shadowRadius(5)
                                                                  ,$NativeUi$Style.transform(_U.update($NativeUi$Style.defaultTransform
                                                                                                      ,{rotate: $Maybe.Just("10deg")}))]))
                                         ,A2($NativeUi.onPress,address,action)])
                                ,_U.list([$NativeUi.string(content)]));
                    });
       ...
       var view = F2(function (address,count) {
                     return A2($NativeUi.view
                              ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.alignItems("center")]))])
                              ,_U.list([A2($NativeUi.image
                                          ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.height(64)
                                                                            ,$NativeUi$Style.width(64)
                                                                            ,$NativeUi$Style.marginBottom(30)]))
                                                   ,$NativeUi.imageSource("https://raw.githubusercontent.com/futurice/spiceprogram/master/assets/img/logo/chilicorn_no_text-128.png")])
                                          ,_U.list([]))
                                       ,A2($NativeUi.text
                                          ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.textAlign("center"),$NativeUi$Style.marginBottom(30)]))])
                                          ,_U.list([$NativeUi.string(A2($Basics._op["++"],"Counter: ",$Basics.toString(count)))]))
                                       ,A2($NativeUi.view
                                          ,_U.list([$NativeUi.style(_U.list([$NativeUi$Style.width(80)
                                                                            ,$NativeUi$Style.flexDirection("row")
                                                                            ,$NativeUi$Style.justifyContent("space-between")]))])
                                          ,_U.list([A4(button,address,Decrement,"#d33","-"),A4(button,address,Increment,"#3d3","+")]))]));
                  });
       var model = 9000;
       var app = $NativeUi$NativeApp.start({model: model,view: view,update: update});
       var main = app;
       return _elm.Main.values = {_op: _op,app: app,main: main,model: model,view: view,Increment: Increment,Decrement: Decrement,update: update,button: button};
    };
module.exports = Elm;
